                ...
                new Typed('#projects-typing', {
                    ...
                    onComplete: function(self) {
                        ...
                        $output.append(`<p>>> 1. MeeA Community Platform - [A social platform for young developers] (Tech: HTML, CSS, JS, PHP, MySQL) <a href="https://github.com/aminatpwk/codding-community-platform" class="text-blue-400 underline" target="_blank">GitHub</a></p>
                                ...
                                <p>>> 3. Memory Card Game - [Game] (Tech: ReactJS) <a href="https://dbz-memory-card.netlify.app/" class="text-blue-400 underline" target="_blank">Live Preview</a></p>
                                <p>>> 4. MerrBio - [Agro MarketPlace] (Tech: ReactJS, PHP, MySQL) <a href="https://merrbio.netlify.app/" class="text-blue-400 underline" target="_blank">Live Preview</a></p>
                        `);
                    }
                });
                break;
